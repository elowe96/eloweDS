...
- ***Wayne State University*** | Detroit, MI |M.S. Data Science and Business Analytics | August 2024 - May 2026 | GPA: 3.86/4.0


## Projects
[GoodBelly: Explanatory Causal Modeling for Marketing Budget Optimization](https://github.com/elowe96/GoodBelly_CaseStudy)
- Developed a **causal explanatory framework using Multiple Linear Regression (MLR)** to quantitatively validate the sales lift generated by in-store demonstrations and endcap promotions, successfully protecting the brand’s marketing budget from proposed cuts.
- Analyzed a multi-channel panel dataset consisting of 1,386 observations across 126 Whole Foods stores over a 10-week period to identify key drivers of weekly unit sales volume.
